...
public class music{
    ...
    String[] Title = {"title: Gemini ", "title: Scorpion ", "title: Emergency Tsunami ", "title: Artist 2.0 ", "title: More Life "};
    String[] Artist = {"by Macklemore ", "by Drake ", "by Nav ", "by A Boogie Wit Da Hoodie ", "by Drake "};
